# Docker Compose to Kubernetes Starter Atlas Codex and Agent Guide
...
- Copilot skill entrypoint: `.github/skills/docker-compose-kubernetes-atlas/SKILL.md`
- Antigravity skill entrypoint: `.agent/skills/docker-compose-kubernetes-atlas/SKILL.md`
